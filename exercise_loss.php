...
<body>
    <section id="Home">
        ...
        <div class="container">
            <div class="row">
                <div class="col-md-12">
                    <h3 class="mt-5 bmi_heading">Exercises For Lose Weight</h3>
                </div>
        
            </div>
            <div class="row">
                <div class="col-md-12">
                    <h1 class="mt-5 bmi_subhead"><center>Week 1 to 2</center></h1>
                </div>
            ...
            <div class="row">
                <div class="col-md-4">
                    <div class="exercise bmi_profile">
                        <h2>Monday</h2>
                        <ul>
                            <li>Warm-up: 10 minutes on a stationary bike or treadmill</li>
                            <li>Cardio: 30 minutes of jogging or brisk walking</li>
                            <li>Strength Training: 3 sets of 10 reps of squats, lunges, push-ups, and bench dips
                            </li>
                            <li>Cool-down:Cool-down: 5-10 minutes of stretching</li>
                ...
                <div class="col-md-4">
                    <div class="exercise bmi_profile">
                        ...
                        <ul>
                            <li>Warm-up: 10 minutes on a stationary bike or treadmill</li>
                            <li>Cardio: 30 minutes of cycling or stair climbing</li>
                            <li>Strength Training: 3 sets of 10 reps of deadlifts, shoulder press, bicep curls, and tricep extensions</li>
                ...
                <div class="col-md-4">
                    <div class="exercise bmi_profile">
                        ...
                        <ul>
                            <li>Warm-up: 10 minutes on a stationary bike or treadmill</li>
                            <li>Cardio: 30 minutes of swimming or rowing</li>
                            <li>Strength Training: 3 sets of 10 reps of leg press, calf raises, lat pulldowns, and dumbbell rows</li>
                            <li>Cool-down: 5-10 minutes of stretching</li>
                        </ul>
                    </div>
                </div>
            ...
            <div class="row">
                <div class="col-md-12">
                    <h1 class="mt-5 bmi_subhead"><center>Week 3 to 4</center></h1>
                </div>
            </div>
            <div class="row">
                <div class="col-md-4">
                    <div class="exercise bmi_profile">
                        ...
                        <ul>
                            <li>Warm-up: 10 minutes on a stationary bike or treadmill</li>
                            <li>Cardio: 40 minutes of interval training (alternating between high-intensity and low-intensity periods)</li>
                            <li>Strength Training: 3 sets of 12 reps of lunges, push-ups, bench dips, and crunches
                            </li>
                            <li>Cool-down: 5-10 minutes of stretching</li>
                ...
                <div class="col-md-4">
                    <div class="exercise bmi_profile">
                        ...
                        <ul>
                            <li>Warm-up: 10 minutes on a stationary bike or treadmill</li>
                            <li>Cardio: 40 minutes of cycling or stair climbing</li>
                            <li>Strength Training: 3 sets of 12 reps of squats, shoulder press, bicep curls, and tricep extensions</li>
                            <li>Cool-down: 5-10 minutes of stretching</li>  
                        </ul>
                    </div>
                </div>
                <div class="col-md-4">
                    <div class="exercise bmi_profile">
                        ...
                        <ul>
                            <li>Warm-up: 10 minutes on a stationary bike or treadmill</li>
                            <li>Cardio: 40 minutes of swimming or rowing</li>
                            <li>Strength Training: 3 sets of 12 reps of leg press, calf raises, lat pulldowns, and dumbbell rows</li>
                            <li>Cool-down: 5-10 minutes of stretching</li>
                        </ul>
                    </div>
                </div>
            ...
            <div class="row">
                <div class="col-md-12">
                    <h1 class="mt-5 bmi_subhead"><center>Week 5 to 6</center></h1>
                </div>
            ...
            <div class="row">
                <div class="col-md-4">
                    <div class="exercise bmi_profile">
                        ...
                        <ul>
                            <li>Warm-up: 10 minutes on a stationary bike or treadmill</li>
                            <li>Cardio:  45 minutes of steady-state jogging or brisk walking</li>
                            <li>Strength Training: 3 sets of 15 reps of lunges, push-ups, bench dips, and crunches
                            </li>
                            <li>Cool-down: 5-10 minutes of stretching</li>
                ...
                <div class="col-md-4">
                    <div class="exercise bmi_profile">
                        ...
                        <ul>
                            <li>Warm-up: 10 minutes on a stationary bike or treadmill</li>
                            <li>Cardio: 45 minutes of cycling or stair climbing</li>
                            <li>Strength Training: 3 sets of 15 reps of squats, shoulder press, bicep curls, and tricep extensions</li>
                            <li>Cool-down: 5-10 minutes of stretching</li>  
                        </ul>
                    </div>
                </div>
                <div class="col-md-4">
                    <div class="exercise bmi_profile">
                        ...
                        <ul>
                            <li>Warm-up: 10 minutes on a stationary bike or treadmill</li>
                            <li>Cardio: 45 minutes of swimming or rowing</li>
                            <li>Strength Training: 3 sets of 15 reps of leg press, calf raises, lat pulldowns, and dumbbell rows</li>
                            <li>Cool-down: 5-10 minutes of stretching</li>
                        </ul>
                    </div>
                </div>
            ...
            <div class="row">
                <div class="exercise col-12">
                    <h4>It's important to note that weight loss is a complex process that involves a combination of diet, exercise, and lifestyle changes. Therefore, it's essential to focus on creating a healthy and sustainable routine that fits your individual needs and preferences. Also, it's important to gradually increase the intensity and duration</h4>
                </div>
            </div>
